...
const TestimonialsSection = () => {
  return (
    <div className='pb-14 px-8 md:px-0'>
      <h2 className='  text-3-xl font-medium text-gray-800'>Testimonials</h2>
      ...
      <div className='grid [grid-template-columns:repeat(auto-fit,minmax(200px,1fr))] gap-8 mt-14 max-w-5xl mx-auto'>
